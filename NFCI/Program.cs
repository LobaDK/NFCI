            ...
            do //main menu loop
            {
                ...
                if (UserChoice == "WebM")
                {
                    do
                    {
                        ...
                        {
                            ShowFfmpegPass2(FfmpegPass2);
                            var BitrateOption = Prompt.Select("Please select a bitrate option. A help option is also available", new[] { "Variable", "Constant", "Help" }); //Uses Sharprompt for the WebM's bitrate options
                            if (BitrateOption == "Help")
                            {
                                BitrateHelp();
                            }
                            if (BitrateOption == "Variable") //menu if the Variable bitrate option was chosen
                            {
                                ShowFfmpegPass2(FfmpegPass2);
                            ...
                            else if (BitrateOption == "Constant") //menu if the Constant bitrate option was chosen
                            {
